...
_lr_productions = [
  ...
  ('comandos -> comando comandos','comandos',2,'p_grammar1','output.py',43),
  ('comandos -> <empty>','comandos',0,'p_grammar2','output.py',47),
  ('comando -> stat','comando',1,'p_grammar3','output.py',51),
  ('stat -> VAR = exp','stat',3,'p_grammar4','output.py',55),
  ('stat -> exp','stat',1,'p_grammar5','output.py',59),
  ('exp -> exp + exp','exp',3,'p_grammar6','output.py',63),
  ('exp -> exp - exp','exp',3,'p_grammar7','output.py',68),
  ('exp -> exp * exp','exp',3,'p_grammar8','output.py',72),
  ('exp -> exp / exp','exp',3,'p_grammar9','output.py',76),
  ('exp -> ( exp )','exp',3,'p_grammar10','output.py',80),
  ('exp -> NUMBER','exp',1,'p_grammar11','output.py',84),
  ('exp -> VAR','exp',1,'p_grammar12','output.py',88),
]
